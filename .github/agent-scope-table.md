...
| `agent/feedback-predecessor-ci-v24` | `.github/agent-scope-table.md`, `.github/ci-governance.json`, `.github/workflows/feedback-predecessor.yml`, `internal/verify/scope_part01.go`, `scripts/feedback-predecessor-ci` |
