...
| `agent/metric-intervention-v8` | `.github/agent-scope-table.md`, `.github/ci-governance.json`, `.github/workflows/metric-intervention.yml`, `internal/meta/metriccounterfactualverify/intervention/**`, `internal/meta/metriccounterfactualverify/intervention/verify/**`, `internal/verify/scope_part01.go`, `scripts/metric-intervention/**` |
