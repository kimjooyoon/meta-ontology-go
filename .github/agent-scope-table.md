...
| `agent/language-concept-artifact-ci-v28` | `.github/agent-scope-table.md`, `.github/ci-governance.json`, `.github/workflows/language-concept-artifact.yml`, `cmd/language-concept-artifact-witness`, `internal/verify/scope_part01.go` |
