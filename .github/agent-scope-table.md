...
| `agent/readiness-push-continuity` | `.github/agent-scope-table.md`, `.github/ci-governance.json`, `.github/workflows/metric-counterfactual.yml`, `docs/language/readiness-push-continuity.md`, `internal/verify/readiness_push_continuity_test.go`, `internal/verify/scope_language_readiness.go` |
