...
// assertSemanticDeltaOracle compares the semantic fact stream and affected
// closure directly. Cache-key equality is checked separately below so a
// broken key implementation cannot make its own oracle pass.
