...
const (
	ReportSchema             = "gooo.language.operation-catalog/v3"
	...
	OperationClaimEventTotal = OperationSpecAxisTotal * 2
...
type Report struct {
	...
	ClaimTransitionHead  string                         `json:"claim_transition_head_digest"`
