...
func TestProjectSelfImprovementProvenanceChainPart01ExposesEvidenceBoundary(t *testing.T) {
	...
	if projection.Status != generation.SelfImprovementProvenanceChainBoundPart01 ||
		projection.CausalReason != generation.SelfImprovementProvenanceChainCompleteReasonPart01 {
...
func TestProjectSelfImprovementProvenanceChainPart01PreservesUnknown(t *testing.T) {
	...
	if projection.Status != generation.SelfImprovementProvenanceChainUnknownPart01 ||
