...
func (server *Server) canRunAsync(request requestEnvelope) bool {
	...
	case "textDocument/hover", "textDocument/completion", "textDocument/definition", "textDocument/semanticTokens/full", "gooo/documentProvenance", "gooo/selfImprovementProvenance", "gooo/referencesProvenance", "gooo/diagnosticProvenance", "gooo/completionProvenance":
		return true
	default:
		return false
	}
