...
func TestEvaluateClosesFixedUserUseCase(t *testing.T) {
	...
	if report.Decision != "PASS" || report.Resolution != "EXACT" || report.Summary.Coordinates.Satisfied != 8 || report.Summary.Coordinates.Total != 8 || report.Summary.UserDecisions != 2 || report.Summary.GeneratedInstances != 1 || report.Summary.GeneratedGoldenMatches != 1 || report.PromotionCreditBPS != 0 {
