...
func DefaultRegistry() []Binding {
	return []Binding{
		...
		{Operation: sourcepolicy.OperationExtractFunction, IndependenceGroupID: "source-extraction", ProofChoice: ProofFoundation, Executor: "bootstrap/function-extractor", Evaluator: ".github/workflows/repository-projection.yml", RequiredIndicatorIDs: []string{"filesystem.atomic-replacement/v1", "go.header.preserved/v1", "go.import.identity/v1", "go.package.conformance/v1", "go.format.fixed-point/v1"}, ReceiptRequired: true, Priority: 30},
	}
}
