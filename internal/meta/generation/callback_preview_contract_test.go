...
func TestCallbackPreviewContractIsTypedAndPreviewOnly(t *testing.T) {
	...
	for _, required := range []string{
		...
		"BoundedCallbackCandidate.SourceStructureState",
		"BoundedCallbackCandidate.SourceStructureDigest",
		"BoundedCallbackCandidate.CaptureReferenceCount",
		"BoundedCallbackCandidate.CallExpressionCount",
