...
func buildTransitions(semantic Semantic, complete bool, violations int, semanticErr bool, writeSetTo, writeSetReason string) []ClaimTransition {
	...
	return []ClaimTransition{
		...
		{Sequence: 3, ClaimID: "read-only-observation", From: "OPEN", To: writeSetTo, Stage: "REDUCE", Step: "effect-verdict", Reason: writeSetReason},
	}
}
