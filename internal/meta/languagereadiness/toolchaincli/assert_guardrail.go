...
const rootUsage = "usage: gooo <run|profile|debug|emit|check|generate|roundtrip|query|inspect|graph|analyze|format|fix|provenance|selective-ci|lsp|version> [args]\n"
