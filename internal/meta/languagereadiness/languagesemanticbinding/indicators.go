...
func buildIndicators(summary Summary) []Indicator {
	definitions := []struct {
		...
		{"gooo.metric.language.semantic-readiness-completed-obligations.v1", "DRIVER", "COHERENCE", "bind-fixed-readiness-count", summary.ReadinessCompleted, 15},
		{"gooo.metric.language.semantic-readiness-executed-cases.v1", "DRIVER", "COHERENCE", "bind-semantic-corpus", summary.SemanticSatisfied, 18},
