...
func sourceFrom(selection selectionView, contract contractView, contractRaw []byte) Source {
	return Source{
		Selection: SelectionSource{
			...
			HeadSHA: selection.Selected.HeadSHA, HeadBranch: selection.Selected.HeadBranch, Event: selection.Selected.Event,
			Status: selection.Selected.Status, Conclusion: selection.Selected.Conclusion,
			WorkflowName:           selection.Selected.WorkflowName,
			SynthesisJobID:         selection.Selected.SynthesisJobID,
			SynthesisJobName:       selection.Selected.SynthesisJobName,
			SynthesisJobStatus:     selection.Selected.SynthesisJobStatus,
			SynthesisJobConclusion: selection.Selected.SynthesisJobConclusion,
			...
			OtherRouteRuns:              selection.Summary.OtherRouteRuns,
			RouteUnknownRuns:            selection.Summary.RouteUnknownRuns,
			Contradictions:              selection.Summary.Contradictions,
			ObservedJobs:                selection.Summary.ObservedJobs,
			ExactJobs:                   selection.Summary.ExactJobs,
