...
func TestGuardrailsFailClosed(t *testing.T) {
	...
	for _, test := range tests {
		...
		if receipt.Decision != DecisionFailClosed || Validate(receipt, testRepository, testCurrent, testEvidence) == nil {
...
func TestDigestTamperFailsClosed(t *testing.T) {
	...
	if Validate(receipt, testRepository, testCurrent, testEvidence) == nil {
