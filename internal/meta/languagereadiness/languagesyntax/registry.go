...
func expectedRegistry() Registry {
	...
	cases := []CaseDefinition{
		...
		invalid("unterminated-string", "examples/language-syntax-roundtrip/unterminated-string.txt", "parse.unterminated-string"),
		...
		valid("meta-circular-boundary", "examples/meta-circular-boundary/main.gooo"),
	}
	return Registry{Schema: RegistrySchema, Cases: cases, PackageUnits: []PackageDefinition{packageUnit, symbolicUnit}}
}
