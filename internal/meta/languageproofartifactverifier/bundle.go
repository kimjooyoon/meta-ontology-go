...
func InputFromBundle(bundle Bundle) (Input, error) {
	...
	interventions := []InterventionInput{
		{ID: "semantic-source-intervention", Kind: "SEMANTIC", Before: SubjectInput{Artifact: content["artifact.json"], Source: content["source.gooo"], Operation: content["operation-receipt.json"], Recipe: content["recipe.json"], Checkout: bundle.Checkout}, After: SubjectInput{Artifact: content["semantic-intervention-artifact.json"], Source: content["semantic-intervention.gooo"], Operation: content["semantic-operation-receipt.json"], Recipe: content["recipe.json"], Checkout: bundle.Checkout}, PolicyBefore: SubjectInput{Artifact: content["tampered.json"], Source: content["source.gooo"], Operation: content["operation-receipt.json"], Recipe: content["recipe.json"], Checkout: bundle.Checkout}, PolicyAfter: SubjectInput{Artifact: content["tampered.json"], Source: content["semantic-intervention.gooo"], Operation: content["operation-receipt.json"], Recipe: content["recipe.json"], Checkout: bundle.Checkout}},
