...
func InputFromBundle(bundle Bundle) (Input, error) {
	...
	return Input{Contract: contract, ContractBytes: content["contract.json"], HeadSHA: bundle.HeadSHA, ValidArtifact: content["artifact.json"], TamperedArtifact: content["tampered.json"], CoherentTamperedArtifact: content["coherent-tamper.json"], MissingArtifact: content["missing-operation.json"], ByteOnlyArtifact: content["byte-only.json"], WrongRecipe: content["wrong-recipe.json"], RecipeOnlyArtifact: content["recipe-only.json"], MissingAttachment: content["missing-attachment.json"], WrongAttachmentDigest: content["wrong-attachment-digest.json"], UnrelatedTamperedArtifact: content["unrelated-tamper.json"], StaleHeadArtifact: content["stale-head.json"], UnauthorizedConsumer: content["unauthorized-consumer.json"], Source: content["source.gooo"], Operation: content["operation-receipt.json"], Recipe: content["recipe.json"], Independence: independence, WriteSet: writeSet, CoherentOperation: content["coherent-operation-receipt.json"], Interventions: interventions, Checkout: bundle.Checkout, BundleDigest: bundle.Digest}, nil
}
