...
func Catalog() []Concept {
	return []Concept{
		...
		concept("causal-feedback-chain", "a green artifact is not necessarily the cause", "the unique exact predecessor receipt becomes explicit state", "select-predecessor-feedback", "CONFORMED",
			[]string{"internal/meta/feedbackpredecessor", "internal/meta/feedbackstate"}, []string{"gooo.metric.meta.predecessor-feedback-readiness.coverage-bps.v1"},
