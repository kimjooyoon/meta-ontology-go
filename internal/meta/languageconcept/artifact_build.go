...
func buildArtifact(repository fs.FS, concepts []Concept) Artifact {
	...
	artifact := Artifact{Schema: ArtifactSchema,
		Producer:           "languageconcept.BuildArtifact",
		Consumer:           "self-improvement-cycle",
		MetaOperation:      "bind-language-concept-artifact",
		CatalogSource:      CatalogSourcePath,
		CatalogDigest:      digest(concepts),
		Report:             report,
		ReplayReportDigest: replay.ReportDigest,
		ReplayEqual:        reflect.DeepEqual(report, replay),
		Bindings:           bindings,
		RepositoryWrites:   0}
