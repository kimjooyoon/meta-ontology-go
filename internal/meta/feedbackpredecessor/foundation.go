...
type FoundationEvidence struct {
	...
	LastKnownGoodFeedbackReportDigest   string   `json:"last_known_good_feedback_report_digest"`
	LastKnownGoodResolutionReportDigest string   `json:"last_known_good_resolution_report_digest"`
	LastKnownGoodFeedbackReason         string   `json:"last_known_good_feedback_reason"`
...
func FoundationEvidenceForConfirmedGap() FoundationEvidence {
	return FoundationEvidence{
		...
		LastKnownGoodFeedbackReportDigest:   FoundationLastKnownGoodFeedbackReportDigest,
		LastKnownGoodResolutionReportDigest: FoundationLastKnownGoodResolutionReportDigest,
		LastKnownGoodFeedbackReason:         FoundationLastKnownGoodFeedbackReason,
