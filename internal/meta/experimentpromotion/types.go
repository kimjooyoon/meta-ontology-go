...
const (
	ContractSchema      = "gooo/experiment-promotion-contract/v1"
	...
	ExperimentCount     = 30
	GateCount           = 5
	GateSlotCount       = ExperimentCount * GateCount
...
// EmittedClaim is derived from a gate result. It is intentionally separate
// from the persistent ledger so guardrails count emitted claim classes rather
// than treating a constant zero as an observation.
