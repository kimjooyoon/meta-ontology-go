...
func toolchainFixture(head string) []byte {
	surfaces := []any{
		surfaceFixture("language-syntax-roundtrip", "gooo/language-syntax-roundtrip/v1", head, 18),
		surfaceFixture("language-semantic-model", "gooo/language-semantic-model/v1", head, 21),
	...
	return fixtureJSON(map[string]any{"schema": "gooo/toolchain-conformance-report/v1",
		...
		"summary": map[string]any{"surfaces_satisfied": 9, "surfaces_total": 9,
			"cases_satisfied": 158, "cases_total": 158, "executed_cases": 158,
