...
func validateDenominator(value denominator) error {
	...
	validHeader := ((value.DenominatorID == "gooo.denominator.capability.vertical-slice-closure.v21" && value.Version == 21) ||
		...
		(value.DenominatorID == "gooo.denominator.capability.vertical-slice-closure.v30" && value.Version == 30)) || (value.DenominatorID == "gooo.denominator.capability.vertical-slice-closure.v31" && value.Version == 31)
