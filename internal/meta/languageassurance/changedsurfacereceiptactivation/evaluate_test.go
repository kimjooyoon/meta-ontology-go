...
func TestExactActivation(t *testing.T) {
	...
	if first.Summary.BeforeOperating != 8 || first.Summary.AfterOperating != 9 || first.Summary.BeforeCoverageBPS != 6666 || first.Summary.AfterCoverageBPS != 7500 || first.Summary.CapsulesExact != 2 || first.Summary.PredecessorSemanticsBPS != 10000 {
