...
const (
	...
	ReasonSnapshotMismatch    = "ASSURANCE_SNAPSHOT_BINDING_MISMATCH"
...
func CanonicalMetaOperations() []MetaOperation {
	return []MetaOperation{
		...
		{ID: "detect-candidate-leakage", Activity: "DetectCandidateLeakage", ProofChoice: ProofCoherence}, {ID: "totalize-changed-surface-receipts", Activity: "TotalizeChangedSurfaceReceipts", ProofChoice: ProofCoherence},
