...
func canonicalLatticeMetrics(counterfactuals []LatticeCounterfactual, claims []ClaimRecord) []LatticeMetric {
	...
	return []LatticeMetric{
		...
		metric("gooo.metric.meta-resolution-lattice.claim-preservation.count.v1", "driver", preservedClaims, "cases", "greater_or_equal", "semanticresolution.ReplayPartialObservation", "semantic-resolution-lattice-judge", "preserve-claim-state", ProofLevelRegression),
