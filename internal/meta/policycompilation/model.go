...
type CaseSummary struct {
	...
	CanonicalCaseDenominator       int `json:"canonical_case_denominator"`
	PassCount                      int `json:"pass_count"`
	FailClosedCount                int `json:"fail_closed_count"`
	UnknownCount                   int `json:"unknown_count"`
	GeneratedIndependentEquivalent int `json:"generated_independent_equivalent"`
...
type PublicCLIEvidence struct {
	Path             string `json:"path"`
	CheckExit        int    `json:"check_exit"`
	GenerateExit     int    `json:"generate_exit"`
	CheckObserved    bool   `json:"check_observed"`
	GenerateObserved bool   `json:"generate_observed"`
}
...
type Receipt struct {
	...
	PublicCLI       PublicCLIEvidence     `json:"public_cli"`
