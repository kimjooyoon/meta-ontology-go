...
func TestGeneratedBillingProjectionLiftsAgainstDeclaredContract(t *testing.T) {
	...
	reconcile := ReconcileSemantic(adapted, expected, adapted.SourceDigest, policy.Digest(), ToolchainDigest(toolchain))
...
func TestGeneratedBillingByteMutationFailsReconcileWithoutWrite(t *testing.T) {
	...
	reconcile := ReconcileSemantic(second, first.IR, first.SourceDigest, first.PolicyDigest, first.ToolchainDigest)
	if reconcile.SourceMatch || reconcile.Accepted {
...
func TestGeneratedBillingWrongIdentityFailsReconcileWithoutWrite(t *testing.T) {
	...
	expected := declaredBillingContract(t)
	reconcile := ReconcileSemantic(observed, expected, observed.SourceDigest, policy.Digest(), observed.ToolchainDigest)
