...
func init() {
	branchScopeAllowlist["agent/value-program-dogfood-sign-20260920"] = []string{
		".github/agent-scope-table.md",
		".github/ci-governance.json",
		".github/workflows/language-value-witness.yml",
		"examples/language-value-witness/README.md",
		"examples/language-value-witness/sign.gooo",
		...
		"internal/meta/languageassurance/verticalsliceclosureshadow/evidence/denominator-v33.json",
		"internal/meta/languageassurance/verticalsliceclosureshadow/denominator_migration_test.go",
		"internal/verify/scope_value_program_dogfood_sign_20260920.go",
	}
}
