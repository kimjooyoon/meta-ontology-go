...
func init() {
	branchScopeAllowlist["agent/value-program-runtime-dogfood-iszero-20260920"] = []string{
		...
		"internal/meta/languageassurance/verticalsliceclosureshadow/evidence/denominator-v42.json",
		...
		"internal/valueexecution/operation_spec_model.go",
