...
func init() {
	branchScopeAllowlist["agent/value-program-runtime-dogfood-add-20260920"] = []string{
		".github/agent-scope-table.md",
		".github/ci-governance.json",
		".github/workflows/language-value-witness.yml",
		"examples/language-value-witness/README.md",
		"examples/language-value-witness/add.gooo",
		...
		"internal/meta/languageassurance/verticalsliceclosureshadow/evidence/denominator-v37.json",
		"internal/meta/languageassurance/verticalsliceclosureshadow/denominator_migration_test.go",
		"internal/verify/scope_value_program_runtime_dogfood_add_20260920.go",
	}
}
