...
func init() {
	branchScopeAllowlist["agent/value-program-operation-mod-20260920"] = []string{
		".github/agent-scope-table.md",
		".github/ci-governance.json",
		"examples/language-value-witness/README.md",
		"internal/valueexecution/evaluate_test.go",
		"internal/valueexecution/failure.go",
		...
		"internal/verify/scope_value_program_operation_mod_20260920.go",
	}
}
