...
The accepted upstream coordinate is 31 syntax cases over 34 observed `.gooo` files, 457 physical lines, and 2 package units. Package members remain package inputs rather than additional standalone semantic models.
