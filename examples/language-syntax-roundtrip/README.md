...
It observes all 36 repository `.gooo` files and 449 physical Gooo lines. Its
single-file semantic denominator is exactly 33 cases: 30 valid source units and
