...
The receipt carries source scope `DECLARATION_RESOLUTION_ONLY`; it can prove that a fixed event was reached and expose the trace prefix. It does not claim
