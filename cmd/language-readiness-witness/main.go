...
func main() {
	...
	flag.StringVar(&cfg.conceptOperationScratchDir, "concept-operation-scratch-dir", "", "caller-owned concept-operation replay scratch directory outside the repository")
