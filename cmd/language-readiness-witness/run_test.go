...
func TestRunPublishesExactNineOfTwentyFour(t *testing.T) {
	...
	if receipt.Snapshot.Summary.Completed != 9 || receipt.Snapshot.Summary.Total != 24 ||
		receipt.Snapshot.Summary.ReadinessBPS != 3750 || receipt.FixedPoint.Decision != improvement.NoChange {
