...
type ClaimCountContractRow struct {
...
type Suite struct {
	...
	ClaimCountExpectedTotal                    int                     `json:"claim_count_expected_total"`
	ClaimCountExpectedByCase                   []ClaimCountContractRow `json:"claim_count_expected_by_case"`
