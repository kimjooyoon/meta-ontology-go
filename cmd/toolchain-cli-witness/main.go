...
func main() {
	...
	flag.StringVar(&cfg.corpus, "corpus", "", "fixed toolchain CLI corpus")
	flag.StringVar(&cfg.output, "output", "", "toolchain CLI report output")
	flag.StringVar(&cfg.check, "check", "", "existing toolchain CLI report")
	flag.Parse()
