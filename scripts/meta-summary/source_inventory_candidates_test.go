...
func TestDecodeSelectedSubjectsRequiresGenerationV6Shape(t *testing.T) {
	valid := []byte(`{"schema_version":"gooo/self-improvement-generation/v6","selected":[{"meta_operation":"extract-function","metric_id":"gooo.metric.source.function-lines.v1","subject":"fixture.go:1:Fixture"}]}`)
