...
func TestCIReceiptRejectsTamperedBindingEvidence(t *testing.T) {
	tests := []struct {
		...
		{name: "branch protection", mutate: func(receipt *provenanceReceipt) { receipt.BranchProtection.RequireLastPushApproval = true }},
