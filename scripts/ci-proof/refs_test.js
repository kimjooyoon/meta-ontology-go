...
assert.strictEqual(normalizeProtectedBranchRef('refs/heads/integration'), 'integration');
...
assert.strictEqual(normalizeBaseRef('push', 'refs/heads/integration'), 'integration');
assert.strictEqual(normalizeBaseRef('pull_request', 'refs/pull/106/merge', {base: {ref: 'integration'}}), 'integration');
