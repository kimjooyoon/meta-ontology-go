...
func cycleIndicators(check validation, envelope Envelope, replay bool) []Indicator {
	return []Indicator{
		...
		cycleBooleanIndicator("foundation.project-root-topology-exemption", "FOUNDATION", check.MetricRootTopology),
		cycleBooleanIndicator("foundation.project-root-readme-exemption", "FOUNDATION", check.MetricRootREADME),
