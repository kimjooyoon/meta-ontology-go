...
type SemanticIntervention struct {
	...
	BaselineClaim            string `json:"baseline_claim"`
	MutatedClaim             string `json:"mutated_claim"`
	BaselineCoordinateDigest string `json:"baseline_coordinate_digest"`
	MutatedCoordinateDigest  string `json:"mutated_coordinate_digest"`
	CausalChange             bool   `json:"causal_change"`
	Producer                 string `json:"producer"`
	Consumer                 string `json:"consumer"`
	MetaOperation            string `json:"meta_operation"`
	ProofChoice              string `json:"proof_choice"`
