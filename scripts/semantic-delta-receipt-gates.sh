...
persistent_identity_observed=$(jq -c '{stable_identity_preserved,stable_identity_total,persistent_claim_identity,persistent_claim_identity_total,evidence_only_changes,evidence_only_total,raw_evidence_changed_on_nonsemantic,raw_evidence_nonsemantic_total,semantic_evidence_preserved_on_nonsemantic,semantic_evidence_nonsemantic_total,semantic_target_preserved_on_nonsemantic,semantic_target_nonsemantic_total,claim_recreated_due_only_to_raw_digest,claim_recreated_due_only_to_raw_digest_total,v3_observation_pairs_reconstructed,v3_observation_pairs_total,v3_producer_consumer_exact,v3_producer_consumer_exact_total,v3_persistence_satisfied,v3_persistence_satisfied_total,persistence_decision,persistence_resolution}' "$evolution")
run_gate "persistent-claim-identity" "claim-identity-persistence" "validate-baseline-alternate-mapping" \
  ...
  '$evolution[0].stable_identity_preserved == 31 and $evolution[0].stable_identity_total == 31 and $evolution[0].persistent_claim_identity == 31 and $evolution[0].persistent_claim_identity_total == 31 and $evolution[0].evidence_only_changes == 31 and $evolution[0].evidence_only_total == 31 and $evolution[0].raw_evidence_changed_on_nonsemantic == 31 and $evolution[0].raw_evidence_nonsemantic_total == 31 and $evolution[0].semantic_evidence_preserved_on_nonsemantic == 31 and $evolution[0].semantic_evidence_nonsemantic_total == 31 and $evolution[0].semantic_target_preserved_on_nonsemantic == 31 and $evolution[0].semantic_target_nonsemantic_total == 31 and $evolution[0].claim_recreated_due_only_to_raw_digest == 0 and $evolution[0].claim_recreated_due_only_to_raw_digest_total == 31 and $evolution[0].v3_observation_pairs_reconstructed == 5 and $evolution[0].v3_observation_pairs_total == 5 and $evolution[0].v3_producer_consumer_exact == 5 and $evolution[0].v3_producer_consumer_exact_total == 5 and $evolution[0].v3_persistence_satisfied == 5 and $evolution[0].v3_persistence_satisfied_total == 5 and $evolution[0].persistence_decision == "FIXED_POINT" and $evolution[0].persistence_resolution == "EXACT" and ([$evolution[0].cases[] | select(.reconstruction_exact == true and .persistence_satisfied == true and .persistence_exact == true and .producer_persistence.decision == "FIXED_POINT" and .producer_persistence.resolution == "EXACT" and .consumer_persistence.decision == "FIXED_POINT" and .consumer_persistence.resolution == "EXACT" and .stable_identity_preserved == .stable_identity_total and .evidence_only_changes == .evidence_only_total and .producer_persistence.raw_evidence_changed == .producer_persistence.raw_evidence_total and .producer_persistence.semantic_evidence_preserved == .producer_persistence.semantic_evidence_total and .producer_persistence.semantic_target_preserved == .producer_persistence.semantic_target_total)] | length) == 5'
